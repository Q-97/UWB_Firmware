...
* Date:   2023 - 5
*****************************************************************************/
#ifndef __ZN_REGS_ZN2015_H
#define __ZN_REGS_ZN2015_H
...
#define SYS_MASK1_ID                         (0x04)

#define SYS_MASK_MRXSAT_BIT_OFFSET  (15U)
#define SYS_MASK_MRXSAT_BIT_LEN     (1U)
#define SYS_MASK_MRXSAT_BIT_MASK    0x8000U

//******************************************************************************
//* Description: Bit definitions for register SYS_STATUS
//******************************************************************************
#define SYS_STATUS_ID                        (0x08)                 
...
#define SYS_STATUS1_ID                        (0x0C)

#define SYS_STATUS1_RXSAT_BIT_OFFSET  (15U)
#define SYS_STATUS1_RXSAT_BIT_LEN     (1U)
#define SYS_STATUS1_RXSAT_BIT_MASK    0x8000U

//******************************************************************************
//* Description: Bit definitions for register SYS_TIME
//******************************************************************************
#define SYS_TIME_ID                          (0x14)
...
//******************************************************************************
//* Description: Bit definitions for register rx0 LNA_AND_TIA_RELATED0_ID
//******************************************************************************
#define LNA_AND_TIA_RELATED0_ID           (0x0818)

#define D_I_TIA_FB_RES_BIT_OFFSET           (10U)
#define D_I_TIA_FB_RES_BIT_LEN              (5U)
#define D_I_TIA_FB_RES_BIT_MASK             0x7C00U

//******************************************************************************
//* Description: Bit definitions for register PLL_STATUS
//******************************************************************************
#define PLL_STATUS_ID                       (0x081c)         
#define PLL_STATUS_LEN                      (4U)                
#define PLL_STATUS_MASK                     0xFFUL

//******************************************************************************
//* Description: Bit definitions for register rx0 LNA_AND_TIA_RELATED1_ID
//******************************************************************************
#define LNA_AND_TIA_RELATED1_ID             (0x0820)
...
//******************************************************************************
//* Description: Bit definitions for register rx1 LNA_AND_TIA_RELATED_2ND_ID
//******************************************************************************
#define LNA_AND_TIA_RELATED_2ND_ID             (0x0850)
...
#define ANALOG_ANTENNA_SWITCH_ID                         (0x105C)
...
//******************************************************************************
//* Description: Bit definitions for register TX_FLG_REG
//******************************************************************************
#define TX_FLG_ID                             (0x1068)
#define TRX_RADAR_MODE_SEL_BIT_OFFSET         (15U)
#define TRX_RADAR_MODE_SEL_BIT_LEN            (1U)
#define TRX_RADAR_MODE_SEL_BIT_MASK           0x8000U

#define TX_CLK_FORCE_OFF_BIT_OFFSET           (14U)
#define TX_CLK_FORCE_OFF_BIT_LEN              (1U)
#define TX_CLK_FORCE_OFF_BIT_MASK             0x4000U

#define TX_PA_GAIN_SEL_BIT_OFFSET             (10U)
#define TX_PA_GAIN_SEL_BIT_LEN                (4U)
#define TX_PA_GAIN_SEL_BIT_MASK               0x3c00U

#define TX_PA_GAIN_FLG_SEL_BIT_OFFSET         (6U)
#define TX_PA_GAIN_FLG_SEL_BIT_LEN            (4U)
#define TX_PA_GAIN_FLG_SEL_BIT_MASK           0x3c0U

#define TX_GAIN_FLG_SEL_BIT_OFFSET            (5U)
#define TX_GAIN_FLG_SEL_BIT_LEN               (1U)
#define TX_GAIN_FLG_SEL_BIT_MASK              0x20U

#define CLKPLL_480M_DIV_BIT_OFFSET            (0U)
#define CLKPLL_480M_DIV_BIT_LEN               (5U)
#define CLKPLL_480M_DIV_BIT_MASK              0x10

//******************************************************************************/
// Description: Bit definitions for register IP CIA
//******************************************************************************/
#define IP_CIA_ID                             (0x1600)           
...
//******************************************************************************/
#define IP_STS_TX_STAMP_H32                     (0x172C)                 
...
//******************************************************************************/
#define IP_STS_TX_STAMP_L8                      (0x1730)                 
#define IP_STS_TX_STAMP_L8_LEN                  (1U)                
#define IP_STS_TX_STAMP_L8_MASK                 0xffU

//******************************************************************************/
// Description: Bit definitions for register load SFD_TYPE_USED_ID
//******************************************************************************/
#define SFD_TYPE_USED_ID                       (0x1738)

#define SFD_LEN_BIT_OFFSET                     (1U)
#define SFD_LEN_BIT_LEN                        (1U)
#define SFD_LEN_BIT_MASK                       0x02

#define SFD_CONFIGED_BIT_OFFSET                (0U)
#define SFD_CONFIGED_BIT_LEN                   (1U)
#define SFD_CONFIGED_BIT_MASK                  0x01

#define SFD_SEQUENCE_ID                       (0x173C)

//******************************************************************************/
// Description: Bit definitions for register SYS_CFG
//******************************************************************************/
#define SYS_CFG_ID                              (0x1810)                 
...
#define SYSTEM_PARAM_RF_CHAN_BIT_MASK           0x7U           //1,2,3,5,6,8,9,10    

//******************************************************************************/
// Description: Bit definitions for register High 32 bit of Transmit Time Stamp
//******************************************************************************/
#define TX_STAMP_H32_ID                         (0x182c)
...
//******************************************************************************/
#define PRF_MODE_ID                              (0x1878)                 
#define PRF_MODE_LEN                             (4U)                
#define PRF_MODE_MASK                            0xFFFFFFFFUL

#define VGA_GAIN_OVRD_BIT_OFFSET                 (31U)                
#define VGA_GAIN_OVRD_BIT_LEN                    (1U)               
#define VGA_GAIN_OVRD_BIT_MASK                   0x80000000UL 

#define VGA_GAIN_REG_BIT_OFFSET                  (25U)                
#define VGA_GAIN_REG_BIT_LEN                     (6U)               
#define VGA_GAIN_REG_BIT_MASK                    0x7E000000UL 
...
//******************************************************************************/
// Description: Bit definitions for register dw phr cfg
//******************************************************************************/
#define DW_PHR_CGF_ID                            (0x187C)

#define PREAMBLE_DURING_BIT_OFFSET               (1U)
#define PREAMBLE_DURING_BIT_LNE                  (1U)
#define PREAMBLE_DURING_BIT_MASK                 0x2U

#define PHR_EXTEND_MODE_1_BIT_OFFSET             (0U)
#define PHR_EXTEND_MODE_1_BIT_LNE                (1U)
#define PHR_EXTEND_MODE_1_BIT_MASK               0x1U

//******************************************************************************/
// Description: Bit definitions for register DRX_SFDTOC
//******************************************************************************/
#define PREAMBLE_CFG_ID                           (0x1900)              
...
//******************************************************************************************/
#define IP_DELTA_NOISE_ID                     (0x1a40)            
...
//******************************************************************************/
// Description: Bit definitions for register High 32bits in the TimeStamp_rx2
//******************************************************************************/
#define IP_TOA_H32_ID2                           (0x1b20)            
#define IP_TOA_H32_LEN2                          (4U)                
#define IP_TOA_H32_MASK2                         0xFFFFFFFFUL

#define IP_TOA_H32_BIT_OFFSET2                   (0U)                
#define IP_TOA_H32_BIT_LEN2                      (32U)                
#define IP_TOA_H32_BIT_MASK2                     0xffffffffU

//******************************************************************************/
// Description: Bit definitions for register Low 32bits in the TimeStamp_rx2 
//******************************************************************************/
#define IP_TOA_L8_ID2                            (0x1b24)            
#define IP_TOA_L8_LEN2                           (1U)                
#define IP_TOA_L8_MASK2                          0xFF000000UL

#define IP_TOA_L8_BIT_OFFSET2                    (24U)                
#define IP_TOA_L8_BIT_LEN2                       (8U)                
#define IP_TOA_L8_BIT_MASK2                      0xff000000U

//******************************************************************************/
// Description: Bit definitions for register High 32bits in the STS TimeStamp_rx2
//******************************************************************************/
#define CP_TOA_H32_ID2                          (0x1c0c)            
#define CP_TOA_H32_LEN2                          (4U)                
#define CP_TOA_H32_MASK2                         0xFFFFFFFFUL

#define CP_TOA_H32_BIT_OFFSET2                   (0U)                
#define CP_TOA_H32_BIT_LEN2                      (32U)                
#define CP_TOA_H32_BIT_MASK2                     0xffffffffU

//******************************************************************************/
// Description: Bit definitions for register Low 32bits in the STS TimeStamp_rx2 
//******************************************************************************/
#define CP_TOA_L8_ID2                            (0x1c10)            
#define CP_TOA_L8_LEN2                           (1U)                
#define CP_TOA_L8_MASK2                          0xFF000000UL

#define CP_TOA_L8_BIT_OFFSET2                    (24U)                
#define CP_TOA_L8_BIT_LEN2                       (8U)                
#define CP_TOA_L8_BIT_MASK2                      0xff000000U
